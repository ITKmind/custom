...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"22 22 22 255" // Active window bg color
		"G_InctiveWindow"			"11 11 11 99" // Inactive window bg color
		"G_TitleBg"					"22 22 22 255" // Title bg color
		"G_TitleText"				"255 255 255 255" // Title text color
		"G_Highlight"				"11 188 144 255" // Highlight color
		"G_ConsoleBg"				"22 22 22 255" // Console bg color
		"G_ListBg"					"19 19 19 255" // List bg color
		...
		"G_DisabledText"			"255 255 255 150" // Disabled text color
		...
		"G_ButtonHoverText"			"22 22 22 255" // Button hover text color
		"G_InputBg"					"22 22 22 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "146 114 44 255" // Highlight color
